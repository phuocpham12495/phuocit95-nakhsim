            ...
            <li class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
                    ...
                    <div class="min-w-0 flex-auto">
                        <p class="text-sm font-semibold leading-6 text-gray-900">{{ $competition['league_name'] }}</p>
                        <p class="mt-1 truncate text-xs leading-5 text-gray-500">League id:
                            {{ $competition['league_id'] }}</p>
                    </div>
                </div>
