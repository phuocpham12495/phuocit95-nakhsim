<x-layout>
    ...
    <x-slot:description>Create Job Description</x-slot:description>

    <form method="POST" action="/me/jobs">
        @csrf
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a type="button" class="text-sm font-semibold leading-6 text-gray-900" href="/me">Cancel</a>
            <button type="submit"
