    ...
    <form method="POST" action="/bibleverses/{{ $bibleverse->id }}">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="verse" id="verse"
                                    ...
                                    placeholder="Psalm 119:11" value="{{ $bibleverse->verse }}" required>
                            </div>
                            @error('verse')
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <textarea name="content" id="content" rows="4"
                                    ...
                                    placeholder="I have hidden your word in my heart that I might not sin against you." required>{{ $bibleverse->content }}</textarea>
                            </div>
                            @error('content')
                                <p class="text-xs text-red-500 font-semibold mt-1">{{ $message }}</p>
                            @enderror
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a type="button" class="text-sm font-semibold leading-6 text-gray-900"
                href="/bibleverses/{{ $bibleverse->id }}">Cancel</a>
            <button type="submit"
